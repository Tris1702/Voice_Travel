...
class EntityExtractionRepositoryImpl implements EntityExtractionRepository {
  ...
  @override
  Future<bool> downloadModel() => repo.downloadModel();

  @override
  Future<void> downloadAllModel() => repo.downloadAllModel();

  @override
  void changeSourceLanguage(Language newLanguage) => repo.changeModel(newLanguage);
